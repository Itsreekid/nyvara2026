...
export const CALL_STATUSES: StatusOption[] = [
  ...
  { value: 'attempt_3', label: 'Tentative 3',  bg: 'rgba(249,115,22,0.18)',  color: '#f97316' },
  { value: 'attempt_4', label: 'Tentative 4',  bg: 'rgba(234,88,12,0.18)',   color: '#ea580c' },
  { value: 'attempt_5', label: 'Tentative 5',  bg: 'rgba(194,65,12,0.18)',   color: '#c2410c' },
